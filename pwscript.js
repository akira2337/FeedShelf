(() => {
    ...
    async function _0x9f2a() {
        const _0x1c2b = document.getElementById(_0x4a21[12])[_0x4a21[13]]; // パスワード取得
        if (!_0x1c2b) return;
        ...
        // --- 一般用パスワード "1234" の判定 ---
        if (_0x1c2b === "1234") {
            // "1234" をハッシュ化したファイル名（例：03ac67...html）を指定
            // ※あらかじめ 1234 のハッシュ名で一般用HTMLを作っておく必要があります
            const _0x_gen_hash = "03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4"; 
            _0x4455 = _0x_gen_hash + _0x4a21[8];
        } else {
            // --- それ以外（Admin用など）の判定：従来通りハッシュ化 ---
